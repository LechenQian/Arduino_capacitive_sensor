...
CapacitiveSensor   cs_4_8 = CapacitiveSensor(4,8); // 1M resistor between pins 8 & 11, pin 11 is sensor pin, add a wire and or foil
...
void loop()                    
{
 ...
 long sensor2 = cs_4_8.capacitiveSensor(1);
